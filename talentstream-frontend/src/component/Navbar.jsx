      ...
      <div className="user-info-dropdown">
        <div className="dropdown">
          ...
          <div className="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
            <Link to="/profile" className="dropdown-item" ><i className="dw dw-user1" /> Profile</Link>
            <Link to="/profile-setting" className="dropdown-item" ><i className="dw dw-settings2" /> Setting</Link>
            <Link to="/help" className="dropdown-item"><i className="dw dw-help" /> Help</Link>
            <Link to="/logout" className="dropdown-item" ><i className="dw dw-logout" /> Log Out</Link>
          </div>
        </div>
      </div>
